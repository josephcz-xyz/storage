...
<div class="mdui-container-fluid">
	...
	<form action="" method="post">
		...
		<div class="mdui-textfield">
		  <input class="mdui-textfield-input" type="hidden" name="onedrive_root" value="<?php echo $config['onedrive_root'];?>" disabled/>
		</div>


		<div class="mdui-textfield">
		  <h4>白名单目录</h4>
		  <small><b>要列出的目录(一行一个)<br>开头加<code>/</code><br>清空缓存后生效</b></small>
		  <textarea class="mdui-textfield-input" placeholder="输入后回车换行" name="allow_list"><?=@$config['allow_list'];?></textarea>
		</div>
